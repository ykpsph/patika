```sql
country tablosunda bulunan country sütunundaki ülke isimlerinden 'T' karakteri ile başlayıp 'y' karakteri ile sonlananları sıralayınız.
SELECT country FROM country
WHERE country LIKE 'T%y';
```
